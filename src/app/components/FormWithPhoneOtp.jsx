...
const FormWithPhoneOTP = () => {
  ...
  `}
                        ...
                        {showPhoneOtp &&
                            <div className="grid grid-cols-1 gap-2">
                                <div>
                                    <p className="my-2 text-left pt-1">OTP has been sent to given Number</p>
                                    <OtpInput
                                        value={formik.values.otpPhone}
                                        onChange={(otp) => formik.setFieldValue("otpPhone", otp)}
                                        numInputs={6}
                                        containerStyle={{
                                            justifyContent: 'space-around',
                                            alignItems: "center",
                                        ...
                                        inputStyle={{
                                            ...
                                            outlineColor: '#f9c617',
                                            border:
                                                formik.touched.otpPhone && formik.errors.otpPhone
                                                    ? '1px solid red'
                                                    : '1px solid #ffffff1a',
                                        }}
                                    ...
                                    />
                                    {formik.touched.otpPhone && formik.errors.otpPhone && (
                                        <p className="text-red-500 text-sm mt-2">{formik.errors.otpPhone}</p>
                                    )}
...
export default FormWithPhoneOTP;