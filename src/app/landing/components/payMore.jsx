...
<path d="M28.0011 11.999L11.9996 28.0005" stroke="white" stroke-width="1.25013"/>
<circle cx="14.4994" cy="15.4994" r="3.87535" stroke="white" stroke-width="1.25013"/>
<circle cx="25.5008" cy="24.5002" r="3.87535" stroke="white" stroke-width="1.25013"/>
</svg>
...
<g clip-path="url(#clip0_4104_5135)">
  ...
  return (
    <section className="bg-gradient-to-b from-[#0B0A2F] to-[#101243] text-[#E5E5EA] py-16 relative overflow-hidden text-center">
        ...
        {/* Section Title */}
          ...
          <h4 className="text-lg md:text-2xl font-[200] mb-4">An IB Programme That</h4>
                        <h2 className="text-2xl md:text-3xl xl:text[40px] font-bold text-[#D9C3AA] mb-4">
        ...
        {/* Flip Cards Grid */}
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8  mb-10 justify-center">
