...
const HelpSection = () => {
  ...
  Contact me on <span className="font-medium">+971 800 667788</span> or email <span className="font-medium">support@gtcfx.com</span>
</p>
                        <p className="text-base text-[#956D42]">
                            See you soon! <br />
