      ...
      <div className="mx-auto container md:py-14 py-10">
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div className="relative flex items-center justify-center md:justify-center">
            ...
            <div className="relative z-10 md:w-[360px] w-[260px] drop-shadow-[0_10px_18px_rgba(0,0,0,0.25)] md:ml-2">
              {/* Animated circle waves - positioned behind laptop, centered */}
              <div className="absolute left-1/2 top-1/2 z-0 ">
                {/* Wave 1 */}
                <div
                  className="wave-circle absolute left-1/2 top-1/2 md:h-[350px] h-[260px] md:w-[350px] w-[260px] rounded-full bg-[#B8C0DB]/55"
                  style={{
                    animation: "wave 3s ease-out infinite",
                  }}
                />
                {/* Wave 2 */}
                <div
                  className="wave-circle absolute left-1/2 top-1/2 md:h-[350px] h-[260px] md:w-[350px] w-[260px] rounded-full bg-[#B8C0DB]/40"
                  style={{
                ...
                {/* Wave 3 */}
                <div
                  className="wave-circle absolute left-1/2 top-1/2 md:h-[350px] h-[260px] md:w-[350px] w-[260px] rounded-full bg-[#B8C0DB]/30"
                  style={{
