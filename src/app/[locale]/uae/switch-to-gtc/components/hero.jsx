    ...
    },
    {
      icon: (
        <svg width="60" height="60" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M13.594 12.1941C12.0194 13.7687 11.0395 15.8405 10.8212 18.0566C10.603 20.2727 11.1599 22.4958 12.397 24.3474C13.6341 26.1989 15.475 27.5641 17.6059 28.2106C19.7368 28.857 22.0259 28.7445 24.0832 27.8923C26.1405 27.0402 27.8387 25.5011 28.8884 23.5372C29.9381 21.5733 30.2744 19.3063 29.84 17.1223C29.4055 14.9382 28.2273 12.9724 26.5059 11.5598C24.7846 10.1471 22.6267 9.375 20.3999 9.375" stroke="white" stroke-width="1.25" stroke-linecap="round" />
          <path d="M20.3999 19L15.3999 14" stroke="white" stroke-width="1.25" stroke-linecap="round" />
          <path d="M20.3999 9.5V12" stroke="white" stroke-width="1.25" stroke-linecap="round" />
          <path d="M29.3999 19L27.3999 19" stroke="white" stroke-width="1.25" stroke-linecap="round" />
          <path d="M20.3999 26V28" stroke="white" stroke-width="1.25" stroke-linecap="round" />
          <path d="M13.3999 19L11.3999 19" stroke="white" stroke-width="1.25" stroke-linecap="round" />
          <defs>
      ...
      icon: (
        <svg width="60" height="60" viewBox="0 0 42 41" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g clip-path="url(#clip0_8008_33695)">
            ...
            <path d="M20.8002 7.70972V9.96778" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M20.8002 28.0323V30.2904" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M26.0422 9.22205L24.9938 11.178" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M16.6066 26.8221L15.5582 28.778" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M29.8793 13.3549L28.0631 14.4839" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M13.5365 23.5161L11.7203 24.6451" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M29.8793 24.6451L28.0631 23.5161" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M13.5367 14.4839L11.7205 13.3549" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M26.0422 28.778L24.9938 26.8221" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M16.6066 11.178L15.5582 9.22205" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M31.2838 19H29.187" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M12.4129 19H10.3162" stroke="white" stroke-width="0.6" stroke-linecap="round" stroke-linejoin="round" />
          </g>
          <defs>
