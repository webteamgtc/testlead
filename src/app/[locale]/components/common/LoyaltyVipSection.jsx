    ...
    <section className="relative text-white py-8 md:py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-10">
          ...
          {/* LEFT Content on Desktop | BELOW image on Mobile */}
          <div className="md:col-span-6 text-center md:text-left order-2 md:order-1">
            ...
            <p className="mt-5 text-base sm:text-lg text-[#333333] max-w-xl md:max-w-none">
            ...
            <div className="flex flex-row items-start justify-center md:justify-start mt-10">
              <button
                ...
                onClick={() => {
                  ...
                  // setIsOpen(true); // keep this if setIsOpen exists in your component
                }}
              >
                Register now
              </button>
