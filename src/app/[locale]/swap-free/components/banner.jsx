        ...
        <div className=" grid md:grid-cols-2 items-center gap-10 z-10 relative">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm md:text-base mb-6 leading-relaxed max-w-xl">
              For a limited time, you can get your GTC trading account with a Swap Free option for life! No forms, no special requests, just open a GTC trading account and it’s done. Whether you’re holding trades overnight or are planning long-term moves, you won’t pay a single cent in swaps. It’s our way of giving you full control to trade your strategy, your way, with no hidden fees & no strings attached.
            </p>
            <div className="my-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-white text-center rounded-xl max-w-6xl mx-auto">
              ...
              <div className="flex flex-col items-center space-y-1">
                ...
                <p className="font-semibold text-sm">Swaps?</p>
                <p className="text-xs text-white/80">Not anymore</p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-1">
                ...
                <p className="font-semibold text-sm">Forever</p>
                <p className="text-xs text-white/80">Auto Enabled</p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-1">
                ...
                <p className="font-semibold text-sm">Unlock</p>
                <p className="text-xs text-white/80">Full Control</p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-1">
                ...
                <p className="text-xs text-white/80">Trade Freedom</p>
              </div>
            </div>
