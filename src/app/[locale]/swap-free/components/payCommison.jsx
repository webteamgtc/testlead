    ...
    const features = [
        {
            ...
            title: "Hold Trades Longer",
            description: "No pressure to close positions, stay in as long as you like. "
        },
        {
            icon: (
            ...
            description: "From gold to forex, it all stays Swap Free."
        },
        {
            icon: (
            ...
            description: "Less fees = more in your pocket."
        },
        {
            icon: (
            ...
            title: "Stress-Free Strategy",
            description: "No fees creeping in overnight. Sleep easy."
        },

        {
            ...
            description: "No extra steps. No forms. Just open and go."
        },
        {
            icon: (
            ...
            description: "New to trading or a pro, it works for you."
        }
    ];
    ...
    return (
        ...
        >
            ...
            <div className="relative max-w-6xl mx-auto ainer flex flex-col gap-5 md:gap-5 px-4">
                ...
                <h4 className="text-lg md:text-2xl font-[200]">Why Pay for Swaps?</h4>
                <h2 className="text-2xl md:text-3xl xl:text-[40px] font-bold text-[#D9C3AA]">
                    Switch to GTC & Never Pay Swap Fees Again!
                </h2>
                <p className="text-sm md:text-base xl:text-[22px] text-white max-w-4xl mx-auto leading-relaxed">
                    You're not just skipping overnight fees, you’re unlocking a smarter way to trade. Here’s why traders all over the world are switching to GTC’s Swap Free accounts for life:                </p>
