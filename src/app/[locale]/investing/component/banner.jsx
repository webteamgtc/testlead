...
const HeroSection = ({ setIsOpen, page = "UAE" }) => {
    ...
    return (
        <section
            className=" relative bg-[#000032] bg-cover bg-right bg-no-repeat pb-6 text-[#E5E5EA] overflow-hidden flex flex-col [clip-path:none] md:[clip-path:polygon(0%_0%,100%_0,100%_20%,100%_100%,0%_90%)]"
        >
            {/* ==== TOP LOGO ==== */}
            ...
            <div className="absolute top-0 h-full w-3/5 opacity-70 right-0 pointer-events-none">
                <Image
