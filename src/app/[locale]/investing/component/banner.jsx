...
const HeroSection = ({ setIsOpen, page = "UAE" }) => {
    ...
    return (
        <section
            className=" relative z-10 bg-[#000032] bg-cover bg-right bg-no-repeat pb-6 pt-12 md:pt-16 text-[#E5E5EA] overflow-hidden flex flex-col [clip-path:none] md:[clip-path:polygon(0%_0%,100%_0,100%_20%,100%_100%,0%_90%)]"
        >
