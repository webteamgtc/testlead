...
const IbProgrammeSection = ({ setIsOpen }) => {
  const t = useTranslations("partner.payMore");
  const t2= useTranslations("oman");
  const features = [
    {
      icon: (
    ...
    {
      icon: (
        <svg width="45" height="45" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      icon: (
        <svg width="45" height="45" viewBox="0 0 40 26" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section className="bg-gradient-to-r from-[#293794] to-[#000021] text-[#E5E5EA] py-8 md:py-20 relative overflow-hidden text-center">
      ...
      <div className="relative max-w-6xl mx-auto ainer flex flex-col gap-5 md:gap-5 px-4">
       ...
       <h4 className="text-lg md:text-2xl font-[200]">{t2('subtitle')}</h4>
        <h2 className="text-2xl md:text-3xl xl:text-[40px] font-bold text-[#D9C3AA]">{t('title')}</h2>
        <p className="text-sm md:text-base xl:text-[22px] text-white max-w-4xl mx-auto leading-relaxed">{t('intro')}</p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Footer Text and CTA */}
               <p className="text-sm md:text-base xl:text-2xl font-semibold text-white max-w-4xl mx-auto leading-relaxed mt-2">{t2('outro')}</p>
