...
const IBTestimonials = ({ setIsOpen }) => {
  ...
  const testimonials = [
    {
      text: t2("oman.list.t1.text"),
      name: t2("oman.list.t1.name"),
      stars: 5,
    },
    {
      text: t2("oman.list.t2.text"),
      name: t2("oman.list.t2.name"),
      stars: 4,
    },
    {
      text: t2("oman.list.t3.text"),
      name: t2("oman.list.t3.name"),
      stars: 5,
    },
    {
      text: t2("oman.list.t4.text"),
      name: t2("oman.list.t4.name"),
      stars: 4,
    },
  ];
