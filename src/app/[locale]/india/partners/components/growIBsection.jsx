        ...
        <section className="bg-gradient-to-r from-[#293794] to-[#000021] text-[#E5E5EA] py-8 md:py-20 relative overflow-hidden text-center">
                ...
                <div className="max-w-4xl mx-auto z-10 relative flex flex-col gap-5 md:gap-5">
                    ...
                    <h2 className="text-2xl md:text-3xl xl:text-[40px] font-bold text-[#D9C3AA] max-w-xl mx-auto">
                        Grow Your Partners Business with GTC
                    </h2>
                    <p className="text-base md:text-lg xl:text-[22px]">
                        You’ve seen what GTC brings to the table. Now it’s your turn. Join the partnership programme that’s helping India’s Partners scale faster, earn more, and build lasting trust with their traders.
                    </p>
