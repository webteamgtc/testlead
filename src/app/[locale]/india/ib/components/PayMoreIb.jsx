    ...
    >
      ...
      >
        ...
        <p className="text-sm md:text-base xl:text-2xl font-semibold text-white max-w-4xl mx-auto leading-relaxed mt-2">
          From realtrader bonuses to marketing support and instant payouts,this is the IB programme serious partners are switching to.
        </p>
